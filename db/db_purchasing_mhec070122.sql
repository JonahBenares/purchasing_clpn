...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2022 at 05:10 AM
...
(1, 'Anna Faith Abuda', 0, ''),
(2, 'Joey Agoncillo', 0, ''),
(3, 'Rudy Agraviador', 0, ''),
(4, 'Enrico Brian Ani', 0, 'Plant Manager'),
(5, 'Airelito Bagon', 0, 'Facility In-Charge Officer'),
(6, 'Nestor Beato', 0, ''),
(7, 'Jubert Corteza', 0, ''),
(8, 'Restituto Cuasay', 0, 'MHECO Project Coordinator'),
(9, 'Edenelle F. De Guzman', 0, 'Construction QA Engineer'),
(10, 'Joy Ecal', 0, ''),
(11, 'Hazel Laderas', 0, ''),
(12, 'Rogelio Luna, Jr.', 0, ''),
(13, 'Joel Manibo', 0, ''),
(14, 'Dani Masculino', 0, ''),
(15, 'Ian Medora', 0, ''),
(16, 'Philip John Miciano', 0, 'Plant Manager'),
(17, 'Jamaica Noble', 0, 'Fuel Management Asst.'),
(18, 'Ruther Ornedor', 0, ''),
(19, 'Analyn Purio', 0, ''),
(20, 'Ramir Radaza', 0, ''),
(21, 'Veverly Ramos', 0, ''),
(22, 'Raelyn Vitto', 0, 'Admin Assistant');
...
(3, 1, 'Elaine Dela Cruz', 'elainemhec', 'elaine123'),
(4, 1, 'Daniel Baculo', 'danmhec', 'dan1234');
...
ALTER TABLE `aoq_items`
 ADD PRIMARY KEY (`aoq_items_id`), ADD KEY `aoq_id` (`aoq_id`,`pr_details_id`);

--
-- Indexes for table `aoq_offers`
--
ALTER TABLE `aoq_offers`
 ADD PRIMARY KEY (`aoq_offer_id`), ADD KEY `aoq_id` (`aoq_id`,`vendor_id`,`aoq_items_id`,`pr_details_id`);

--
-- Indexes for table `aoq_vendors`
--
ALTER TABLE `aoq_vendors`
 ADD PRIMARY KEY (`aoq_vendors_id`), ADD KEY `aoq_id` (`aoq_id`,`rfq_id`,`vendor_id`);
...
ALTER TABLE `jo_details`
 ADD PRIMARY KEY (`jo_details_id`), ADD KEY `jo_details_id` (`jo_details_id`,`jo_id`);
...
--
ALTER TABLE `po_dr`
 ADD PRIMARY KEY (`dr_id`), ADD KEY `po_id` (`po_id`,`rfd_id`);
...
--
ALTER TABLE `po_head`
 ADD PRIMARY KEY (`po_id`), ADD KEY `po_id` (`po_id`,`vendor_id`,`user_id`,`approved_by`,`checked_by`,`cancelled_by`,`served_by`,`approve_rev_by`,`recommended_by`,`grouping_id`), ADD KEY `po_id_2` (`po_id`,`vendor_id`,`approved_by`,`checked_by`,`cancelled_by`,`served_by`,`recommended_by`,`grouping_id`);

--
-- Indexes for table `po_items`
--
ALTER TABLE `po_items`
 ADD PRIMARY KEY (`po_items_id`), ADD KEY `pr_id` (`pr_id`,`po_id`,`aoq_offer_id`,`aoq_items_id`,`pr_details_id`,`cancelled_by`);
...
--
ALTER TABLE `po_pr`
 ADD PRIMARY KEY (`po_pr_id`), ADD KEY `po_id` (`po_id`,`pr_id`,`aoq_id`);
...
--
ALTER TABLE `pr_head`
 ADD PRIMARY KEY (`pr_id`), ADD KEY `imported_by` (`imported_by`,`cancelled_by`);
...
ALTER TABLE `pr_vendors`
 ADD PRIMARY KEY (`pr_vendors_id`), ADD KEY `pr_id` (`pr_id`,`vendor_id`,`noted_by`,`approved_by`);
...
--
ALTER TABLE `rfd`
 ADD PRIMARY KEY (`rfd_id`), ADD KEY `rfd_id` (`rfd_id`,`po_id`,`pay_to`,`checked_by`,`endorsed_by`,`approved_by`,`noted_by`,`received_by`,`user_id`);

--
-- Indexes for table `rfd_items`
--
ALTER TABLE `rfd_items`
 ADD PRIMARY KEY (`rfd_items_id`), ADD KEY `rfd_items_id` (`rfd_items_id`,`rfd_id`,`item_id`);

--
-- Indexes for table `rfd_purpose`
--
ALTER TABLE `rfd_purpose`
 ADD PRIMARY KEY (`rfd_purpose_id`), ADD KEY `rfd_purpose_id` (`rfd_purpose_id`,`rfd_id`);
...
ALTER TABLE `rfq_head`
 ADD PRIMARY KEY (`rfq_id`), ADD KEY `vendor_id` (`vendor_id`,`pr_id`,`grouping_id`,`prepared_by`,`noted_by`,`approved_by`,`cancelled_by`);
