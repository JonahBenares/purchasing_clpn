...
(3, 1, 'Elaine Dela Cruz', 'elaineprogen', 'elaine123');
...
--
ALTER TABLE `item`
 ADD PRIMARY KEY (`item_id`), ADD KEY `pr_details_id` (`pr_details_id`);

--
-- Indexes for table `jo_ar`
--
ALTER TABLE `jo_ar`
 ADD PRIMARY KEY (`joar_id`), ADD KEY `joar_id` (`joar_id`,`jo_id`,`requested_by`);
...
ALTER TABLE `jo_details_revised`
 ADD KEY `jo_details_id` (`jo_details_id`,`jo_id`);
...
--
ALTER TABLE `jo_head`
 ADD PRIMARY KEY (`jo_id`), ADD KEY `jo_id` (`jo_id`,`vendor_id`,`prepared_by`,`approved_by`,`checked_by`,`approve_rev_by`,`recommended_by`);
...
ALTER TABLE `po_dr_items`
 ADD PRIMARY KEY (`dr_items_id`), ADD KEY `po_items_id` (`po_items_id`,`dr_id`,`pr_id`,`po_id`,`aoq_offer_id`,`aoq_items_id`,`pr_details_id`,`item_id`);

--
-- Indexes for table `po_dr_items_revised`
--
ALTER TABLE `po_dr_items_revised`
 ADD KEY `po_items_id` (`po_items_id`,`dr_id`,`pr_id`,`po_id`,`aoq_offer_id`,`aoq_items_id`,`pr_details_id`,`item_id`);
...
ALTER TABLE `po_head_temp`
 ADD KEY `vendor_id` (`vendor_id`,`approved_by`,`checked_by`,`cancelled_by`,`served_by`,`approve_rev_by`);

--
-- Indexes for table `po_items`
--
ALTER TABLE `po_items`
 ADD PRIMARY KEY (`po_items_id`), ADD KEY `pr_id` (`pr_id`,`po_id`,`aoq_offer_id`,`aoq_items_id`,`pr_details_id`,`item_id`,`cancelled_by`);
...
ALTER TABLE `pr_calendar`
 ADD PRIMARY KEY (`pr_calendar_id`), ADD KEY `pr_id` (`pr_id`,`pr_details_id`,`proj_act_id`);

--
-- Indexes for table `pr_details`
--
ALTER TABLE `pr_details`
 ADD PRIMARY KEY (`pr_details_id`), ADD KEY `pr_id` (`pr_id`,`grouping_id`,`cancelled_by`,`remark_by`,`company_id`,`onhold_by`,`recom_by`,`vendor_id`,`terms_id`);

--
-- Indexes for table `pr_head`
--
ALTER TABLE `pr_head`
 ADD PRIMARY KEY (`pr_id`), ADD KEY `pr_id` (`pr_id`,`imported_by`,`cancelled_by`);
...
ALTER TABLE `rfd_purpose`
 ADD PRIMARY KEY (`rfd_purpose_id`), ADD KEY `rfd_id` (`rfd_id`,`requestor`);

--
-- Indexes for table `rfq_details`
--
ALTER TABLE `rfq_details`
 ADD PRIMARY KEY (`rfq_details_id`), ADD KEY `rfq_id` (`rfq_id`,`pr_details_id`);

--
-- Indexes for table `rfq_head`
--
ALTER TABLE `rfq_head`
 ADD PRIMARY KEY (`rfq_id`), ADD KEY `vendor_id` (`vendor_id`,`grouping_id`,`prepared_by`,`noted_by`,`approved_by`,`cancelled_by`);
...
--
ALTER TABLE `users`
 ADD PRIMARY KEY (`user_id`), ADD KEY `user_id` (`user_id`,`usertype_id`);
...
ALTER TABLE `vendor_head`
 ADD PRIMARY KEY (`vendor_id`), ADD KEY `category_id` (`category_id`);
