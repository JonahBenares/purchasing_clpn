	    	...
	    	<div style="background: #fff;" class="<?php  if($cancelled==1){ echo 'cancel'; }?>"> <!-- add class cancel -->
		    	<table class="table-borsdered" width="100%" style="border:1px solid #000">
		    		...
		    		<tr>
		    			...
		    			<td colspan="4"><b>Payment Released by:</b></td>
		    			<td colspan="4"><b>Payment Received by:</b></td>
		    		</tr>	
		    		<tr><td class="f13" colspan="20" align="center"><br></td></tr>	
		    		<tr>
		    			<td colspan="3"><b class="nomarg">
		    				<?php if($rows_rfd==0){
		    			...
		    			<td colspan="4">
			    			<b>
			    				<?php if($rows_rfd==0){ ?>
					    			<select name='released' class="select-des emphasis" required style="width:90%">
					    			<option value=''>-Select Employee-</option>
					    			<?php foreach($employee AS $emp){ ?>
					    				<option value='<?php echo $emp->employee_id; ?>'><?php echo $emp->employee_name; ?></option>
					    			<?php } ?>
		    			...
		    			<td colspan="4">
			    			<b>
			    				<?php if($rows_rfd==0){ ?>
					    			<select name='received' class="select-des emphasis" required style="width:90%">
					    			<option value=''>-Select Employee-</option>
					    			<?php foreach($employee AS $emp){ ?>
					    				<option value='<?php echo $emp->employee_id; ?>'><?php echo $emp->employee_name; ?></option>
					    			<?php } ?>
